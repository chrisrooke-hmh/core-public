...
// Audio file paths
let audioPathArray = [
  "sound/ancientrome_sc2_title",
  "sound/ancientrome_sc2_poi_001.mp3",
  "sound/ancientrome_sc2_poi_002.mp3",
  "sound/ancientrome_sc2_poi_003.mp3",
  "sound/ancientrome_sc2_poi_004.mp3",
  "sound/ancientrome_sc2_poi_005.mp3",
  "sound/ancientrome_sc2_poi_006.mp3",
  "sound/ancientrome_sc2_poi_007.mp3"
];
...
function preload() {
  ...
  intro = loadSound("sound/ancientrome_sc2_title.mp3");
  hotSpotSFX = loadSound("sound/hotspot_sfx.mp3");
  infoShowHideSFX = loadSound("sound/info_button_2.wav");
  ambientMusic = loadSound("sound/construction.mp3");
...
function init() {
  ...
  let material = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load("img/rome2_mono.jpg"),
  });
