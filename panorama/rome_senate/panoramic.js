...
let audioPathArray = [
  ...
  "sound/ancientrome_sc3_poi_004.mp3",
  "sound/ancientrome_sc3_poi_005.mp3",
  "sound/ancientrome_sc3_poi_006.mp3",
...
function init() {
  ...
  let material = new THREE.MeshBasicMaterial({
    map: new THREE.TextureLoader().load("img/rome3_mono.jpg"),
  });
